	...
	public class FacebookStyleBarBehaviorDefiner : BLKFlexibleHeightBarBehaviorDefiner
	{
		...
		public override void DraggingStarted (UIScrollView scrollView)
		{
			...
			if((scrollView.ContentOffset.Y+scrollView.ContentInset.Top) >= 0.0 && scrollView.ContentOffset.Y <= (scrollView.ContentSize.Height-scrollViewViewportHeight))
			{
				...
				_previousProgress = FlexibleHeightBar.Progress;
				...
				else
				{
					...
					if((scrollView.ContentOffset.Y+scrollView.ContentInset.Top) > (_thresholdNegativeDirection+(FlexibleHeightBar.MaximumBarHeight-FlexibleHeightBar.MinimumBarHeight)))
					{
		...
		public override void Scrolled (UIScrollView scrollView)
		{
			if(!IsCurrentlySnapping)
			{
				...
				var deltaProgress = deltaYOffset / (FlexibleHeightBar.MaximumBarHeight-FlexibleHeightBar.MinimumBarHeight);

				FlexibleHeightBar.Progress = _previousProgress + deltaProgress;
