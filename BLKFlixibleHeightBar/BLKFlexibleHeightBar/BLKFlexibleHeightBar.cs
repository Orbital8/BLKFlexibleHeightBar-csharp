...
namespace BLKFlexibleHeightBar
{
	public class BLKFlexibleHeightBar : UIView
	{
		...
		public UIView StickyView { get; set; }
		...
		public override void LayoutSubviews ()
		{
			...
			if (StickyView != null)
			{
				var frame = StickyView.Frame;
				StickyView.Frame = new CGRect(frame.X, barFrame.Y + newHeight, frame.Width, frame.Height);
			}
